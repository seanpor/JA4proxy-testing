...
# Save connection details for Ansible
cat > deploy/inventory/hosts.ini << EOF
# Auto-generated by provision-alibaba-cloud.sh
[ja4proxy_vm]
${EIP_ADDRESS} ansible_user=root ansible_ssh_private_key_file=\$HOME/.ssh/id_ed25519 ansible_python_interpreter=/usr/bin/python3
EOF
