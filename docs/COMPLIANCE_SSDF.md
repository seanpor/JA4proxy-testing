...
| Task | Summary | Status | Satisfier / rationale |
|------|---------|--------|-----------------------|
| PS.1.1 | Store all forms of code securely | Yes | Git + GitHub; `.github/workflows/scorecard.yml` runs OpenSSF Scorecard (Phase 18-E); secrets never committed (`deploy/.vault/` is gitignored) |
