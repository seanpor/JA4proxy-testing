...
- [x] 18-B — Trivy image-scan in CI (CRITICAL blocking + expiring allowlist)
- [x] 18-B-2 — HIGH Trivy findings blocking alongside CRITICAL (merged single-pass; 14 residual HIGHs allowlisted with 2026-05-17 expiries)
...
- [x] 18-D — cosign sign-blob provenance for binary + SBOM (PR #52)
- [x] 18-G — weekly Docker Hub digest refresh workflow + pin file (PR #53)
- [x] 18-H — `docs/REQUIREMENTS.md` + traceability check (PR #51)
- [x] 18-I — append-only ADR log under `docs/adr/` + Nygard-format check (PR #54)
...
- [x] 21-I — orphan-check gate for `scripts/ci/check_*.py` (PR #79) — see `docs/phases/PHASE_21_SUPPLY_CHAIN_FRESHNESS.md`
